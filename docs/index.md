...
Проект распространяется под лицензией **MIT** — код можно свободно использовать, изменять и распространять, в том числе в коммерческих проектах, при сохранении текста лицензии и уведомления о копирайте. Полный текст — в файле [`LICENSE`](https://github.com/rumata-ap/AcSapfir/blob/master/LICENSE).
